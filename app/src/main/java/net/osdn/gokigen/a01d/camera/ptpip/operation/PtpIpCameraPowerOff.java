...
public class PtpIpCameraPowerOff implements Preference.OnPreferenceClickListener, ConfirmationDialog.Callback
{
     ...
     *
     */
    public PtpIpCameraPowerOff(Context context, IChangeScene changeScene)
    {
